...
try:
    ...
    def generate_password():
        try:
            ...
            print("Error in generate_password:", e)
    ...
    def copy_to_clipboard():
        try:
            ...
            print("Error in copy_to_clipboard:", e)
    ...
    input("Press Enter to close...")  # Keeps window open if error occurs
